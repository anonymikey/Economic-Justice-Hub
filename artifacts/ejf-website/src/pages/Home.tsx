        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div style={{ animation: "fadeInLeft 0.8s ease both" }}>
            ...
            <p className="text-[#08152F]/70 text-base leading-relaxed mb-4">
              Every generation inherits Natural Wealth — forests, wildlife, rivers, oceans, minerals, rangelands, mountains, and biodiversity. For generations, this wealth has sustained life, shaped cultures, supported economies and inspired human progress.
            </p>
            <p className="text-[#08152F]/70 text-base leading-relaxed mb-4">
              Yet its greatest promise has never been the wealth it contains, but the future it makes possible. That future depends on one defining question:
            </p>
            ...
            <p className="text-[#08152F]/70 text-base leading-relaxed mb-8">
              At EJF, we believe the answer is Economic Justice — when the benefits of Natural Wealth advance Human Dignity, enable Human Rights, promote Equity and create equitable and sustainable Prosperity.
            </p>
            <Link href="/about"
              className="inline-flex items-center gap-2 bg-[#08152F] hover:bg-[#0e2247] text-white font-bold px-7 py-3.5 rounded-xl transition-all text-sm shadow-md">
              Read Our Full Story →
            </Link>
          </div>
...
function EJFIdeaSection() {
  const points = [
    ...
    "Uphold Human Dignity in every context",
    "Enable the full enjoyment of Human Rights",
    "Strengthen Equity and Justice",
    "Create equitable and sustainable Prosperity",
    "Inspire the long-term conservation of Natural Capital",
  ];
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl min-h-[480px]">
          ...
          <div className="relative z-10 p-10 md:p-16 max-w-2xl">
            ...
            <p className="text-white/70 text-base leading-relaxed mb-6">
              We believe the future of people and the future of Natural Capital are inseparable. Natural Wealth should do more than generate economic value. It should:
            </p>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-[#08152F]/55 max-w-2xl mx-auto text-base">
            These are more than our values — they are the principles that shape how we understand Economic Justice and define the future we are committed to building.
          </p>
        </div>
  ...
  return (
    <section className="relative py-28 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-white/65 text-base md:text-lg leading-relaxed mb-4 max-w-2xl mx-auto">
          The future of Natural Wealth cannot be shaped by one institution alone. It requires governments, host communities, indigenous peoples, the private sector, civil society, academia and international institutions working together around a shared vision.
        </p>
        <p className="text-white/50 text-sm md:text-base leading-relaxed mb-10 max-w-2xl mx-auto">
          Together, we can build a world where Natural Wealth fulfils its highest purpose — advancing Human Dignity, enabling Human Rights, promoting Equity and creating equitable and sustainable Prosperity for present and future generations.
        </p>
