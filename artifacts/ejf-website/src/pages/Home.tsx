      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div style={{ animation: "fadeInLeft 0.8s ease both" }}>
            ...
            <p className="text-[#08152F]/70 text-base leading-relaxed mb-4">
              At the Economic Justice Forum (EJF), we believe the answer is Economic Justice. When the opportunities and benefits generated by Natural Wealth advance Human Dignity, enable the full enjoyment of Human Rights, promote Equity, strengthen Justice and create equitable and sustainable Prosperity, Natural Wealth fulfils its highest purpose.
            </p>
            <p className="text-[#08152F]/70 text-base leading-relaxed mb-6">
              In doing so, host communities become rightful partners in shaping the future of the Natural Wealth with which they live. Governments strengthen public trust through accountable leadership. Responsible enterprise creates lasting value. Knowledge and innovation inspire better decisions. And society creates enduring incentives to conserve the Natural Capital upon which present and future generations depend.
            </p>
            <p className="text-[#08152F] font-semibold text-sm mb-8">
              This is the future EJF exists to advance.
            </p>
            <Link href="/about"
